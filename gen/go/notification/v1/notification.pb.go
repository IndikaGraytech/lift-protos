...
var file_notification_v1_notification_proto_goTypes = []any{
	...
	nil,                     // 2: lift.notification.v1.SendOTPRequest.DataEntry
}
var file_notification_v1_notification_proto_depIdxs = []int32{
	2, // 0: lift.notification.v1.SendOTPRequest.data:type_name -> lift.notification.v1.SendOTPRequest.DataEntry
	0, // 1: lift.notification.v1.NotificationService.SendOTP:input_type -> lift.notification.v1.SendOTPRequest
	1, // 2: lift.notification.v1.NotificationService.SendOTP:output_type -> lift.notification.v1.SendOTPResponse
